...
#include "seqmm/sputnik/barrier.h"
#include "seqmm/sputnik/cuda_utils.h"
#include "seqmm/sputnik/load_store.h"
#include "seqmm/sputnik/memory_aligner.h"
#include "seqmm/sputnik/compute_utils.h"
#include "seqmm/sputnik/cuda_spmm.h"
#include "seqmm/sputnik/dense_tile.h"
#include "seqmm/sputnik/output_tile.h"
#include "seqmm/sputnik/predicate_utils.h"
#include "seqmm/sputnik/sparse_tile.h"
#include "seqmm/sputnik/spmm_config.h"
#include "seqmm/sputnik/tiling_utils.h"
#include "seqmm/sputnik/vector_utils.h"
...
__global__ void TransposeKernel(const float *idata, int width, int height,
                                float*odata) {
...
cudaError_t CudaTranspose(const float* src, const int width, const int height,
                          float* dst, cudaStream_t stream) {
  // setup execution parameters
  dim3 grid(width / BLOCK_DIM, height / BLOCK_DIM, 1);
  dim3 threads(BLOCK_DIM, BLOCK_DIM, 1);

  TransposeKernel<<<grid, threads, 0, stream>>>(src, width, height, dst);
